...
#INSP
              #cnt of_h of_l data...
execbmcipmicmd 0x00 0X2B 0x49 0x49 0x4e 0x53 0x50
...
execbmcipmicmd 0x00 0X2B 0x80 0x57 0x30 0x30 0x36 0x30 0x35 0x${tmpcode}
execbmcipmicmd 0x00 0X2B 0x87 0x4d 0x5a 0x37 0x35 0x31 0x31
execbmcipmicmd 0x00 0X2B 0x8D 0x30 0x31 0x30 0x3$l 0x3$m 0x3$n

#FRU PN
execbmcipmicmd 0x00 0X2B 0x93 0x57 0x30 0x30 0x36 0x30 0x35 0x${tmpcode}

#manufacture data:前两个数字表示周，后两个数字表示年；例如： 2017年第一周，表示为“0117”
execbmcipmicmd 0x00 0x2b 0x9a 0x00 0x01 0x01 0x07 
