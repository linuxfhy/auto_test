...
#fru_identify:
#11S W08900G MZ7511 010001
#0x31 0x31 0x53
#0x57 0x30 0x38 0x39 0x30 0x30 0x47
#0x4d 0x5a 0x37 0x35 0x31 0x31
#0x30 0x31 0x30 0x3$l 0x3$m 0x3$n
               #cnt of_h of_l data...
execcmcipmicmd 0x00 0x2F 0x40 0x57 0x30 0x38 0x39 0x30 0x30 0x47
execcmcipmicmd 0x00 0x2F 0x47 0x4d 0x5a 0x37 0x35 0x31 0x31
execcmcipmicmd 0x00 0x2F 0x4D 0x30 0x31 0x30 0x3$l 0x3$m 0x3$n
...
#vpd_mid_fru_part_number_e:W08900G
execcmcipmicmd 0x00 0x2F 0x56 0x57 0x30 0x38 0x39 0x30 0x30 0x47
#log "write vpd_mid_fru_part_number_e:W08900G"
...
#vpd_mid_node1_wwnn_e    56c92bfa0008${l}${m}${n}0
#vpd_mid_node2_wwnn_e    56c92bfa0008${l}${m}${n}1
execcmcipmicmd 0x00 0x2F 0xC0 0x56 0xc9 0x2b 0xfa 0x00 0x08 0x${l}${m} 0x${n}0
execcmcipmicmd 0x00 0x2F 0xC8 0x56 0xc9 0x2b 0xfa 0x00 0x08 0x${l}${m} 0x${n}1
#log "write node1/2_wwnn:56c92bf80100${l}${m}${n}0/56c92bf80100${l}${m}${n}1"



#vpd_mid_node1_SAT_ipv4_address_e    192.168.070.010
execcmcipmicmd 0x00 0x2F 0xE8 0xC0 0xA8 0x46 0x0a
#log "write node1_SAT_ipv4_address:192.168.070.010"
...
#log "write node1_SAT_ipv4_subnet/gateway:255.255.255.000/192.168.070.001"
...
#vpd_mid_node2_SAT_ipv4_address_e    192.168.070.11:
execcmcipmicmd 0x00 0x30 0x28 0xC0 0xA8 0x46 0x0b
#log "write node2_SAT_ipv4_address:192.168.070.011"
...
#log "write node2_SAT_ipv4_gateway:192.168.070.001"
...
#manufactured data  2017-01-01，in day/month/yeaf format:0x01 0x01 0x11
execcmcipmicmd 0x00 0x2f 0x53 0x01 0x01 0x11
